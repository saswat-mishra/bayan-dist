...
import { Runs, formatDate } from '../d7t';
export function Delta({ priorDate, priorBy, priorByYou, changed, sameShapeMeans, lang }: {
    ...
    return <div data-testid="delta"><span data-testid="delta-by"><Runs text={text}/></span>{sameShapeMeans && <span className="muted small"> ({sameShapeMeans})</span>}</div>;
}
